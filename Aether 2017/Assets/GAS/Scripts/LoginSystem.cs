...
public class LoginSystem : MonoBehaviour {
	...
	IEnumerator Query_Account (){
		...
		if (checkBanned.text.Trim () == "1" || checkBanned.text.Trim () == "3") {
			...
			if (split [0].Trim () == "1") {
                ...
                PlayerPrefs.SetString("Guest", "no");
    ...
    public void enterAsGuest()
    {
        ...
        PlayerPrefs.SetFloat("em", 25);
        PlayerPrefs.SetFloat("gr", 100);
        PlayerPrefs.SetFloat("sf", 175);
        PlayerPrefs.SetFloat("wf", 25);
        PlayerPrefs.SetInt("lvl", 65);
        PlayerPrefs.SetString("Guest", "yes");
