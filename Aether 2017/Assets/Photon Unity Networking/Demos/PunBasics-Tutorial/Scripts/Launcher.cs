...
namespace ExitGames.Demos.DemoAnimator
{
	public class Launcher : Photon.PunBehaviour {
		...
		public override void OnPhotonRandomJoinFailed(object[] codeAndMsg)
		{
            ...
            PhotonNetwork.CreateRoom(null, new RoomOptions() { MaxPlayers = this.maxPlayersPerRoom, PublishUserId = true }, null);
		}
		...
		public override void OnJoinedRoom()
		{
			...
			if (PhotonNetwork.room.PlayerCount == 1)
			{
				...
				// #Critical
				// Load the Room Level. 
				//PhotonNetwork.LoadLevel("PunBasics-Room for 1");          //vintage
                PhotonNetwork.LoadLevel("Test Room 1");                     //vintage
